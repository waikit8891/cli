...
func TestEnableRun(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			wantErr:    true,
			wantErrOut: "could not resolve to a unique workflow; found: .github/workflows/disabled.yml (ID: 456) .github/workflows/anotherDisabled.yml (ID: 1213)",
		},
	}
