...
func runEnable(opts *EnableOptions) error {
	...
	if opts.Prompt {
		workflow, err = shared.PromptWorkflows(client, repo, shared.DisabledManually)
		if err != nil {
			return err
		}
	}
	...
	if workflow == nil {
		workflow, err = shared.ResolveWorkflow(opts.IO, client, repo, opts.Selector, shared.DisabledManually)
		if err != nil {
			return err
		}
	}
